...
<object data="Bode Plot Analysis" type="application/pdf" width="100%" height="100%">
    <embed src="Bode_Plot_Analysis.pdf" type="application/pdf">
        <!-- Fallback content for browsers that don't support embedding PDF files -->
        <p>It appears you don't have a PDF plugin for this browser. You can <a href="Bode_Plot_Analysis.pdf">click here to download the PDF file.</a></p>
    </embed>
</object>
